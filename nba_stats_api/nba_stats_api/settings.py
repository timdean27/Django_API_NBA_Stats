"""
Django settings for nba_stats_api project.
...
SECRET_KEY = 'django-insecure-#67c1c_x%wjx0)qbwgxkp&x7!j_@#!2e_+jy^9q7pfvh!xp!yx'
...
WSGI_APPLICATION = 'nba_stats_api.wsgi.application'
